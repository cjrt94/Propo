...
<script>
    ...
    export default {
        ...
        props: ['departments','route','contactsold','addressesold','client','path'],
        ...
        data() {
            ...
            return {
                ...
                contacts: this.contactsold,
                addresses: this.addressesold,
                nameContact: '',
                emailContact: '',
                phoneContact: '',
                ...
                typeDocument: this.client.type_document
        ...
        methods: {
            ...
            getProvinces: function (ev) {
                ...
                var url = this.path+'/admin/provinces' + "/" + this.selectedDep;
            ...
            getDistricts: function (ev) {
                ...
                var url =  this.path+'/admin/districts' + "/" + this.selectedPro;
